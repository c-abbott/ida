...
we only have additional data on the gender of the participants in the survey (swhich is fully
...
get_statistics = function(data) {
 ...
 # Compute mean ignoring missing values
  ...
  cat(sprintf("Mean: %f\nStandard Error: %f\nCorrelation (log-dose): %f\nCorrelation (BP): %f", 
              results$mean, results$se, results$cor$logdose, results$cor$bloodp))
  return(results)
}
```
