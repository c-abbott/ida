...
through comparing empirical confidence intervals for the $\beta_1$ parameter, these methods are
stochastic regression imputation (SRI) and bootstrap sampling.
...
The R code below hence performs a bootstrap imputation method and a SRI imputation
