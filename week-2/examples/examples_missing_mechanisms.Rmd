...
Let us know look at the density plots of the observed, complete, and missing data (remember that we can only do this because we are working with simulated data and so that we have access to the complete data and to the missing data as well). 
```{r, include = TRUE, message = FALSE, tidy = TRUE, fig.align = 'center'}
